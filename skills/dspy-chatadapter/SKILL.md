...
- [reference.md](reference.md) — constructor, all methods, format/parse protocol
- [examples.md](examples.md) — debugging parse failures, mixed adapter pipelines, fine-tuning data generation
